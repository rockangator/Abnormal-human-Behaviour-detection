...
normal_classes = ['hug','drink','sit','eat','clap','stand','wave']
abnormal_classes = ['kiss','pushup','handstand','fallfloor','punch']
      ...
      if scores is None:
        ...
        if not skip_labels:
          if not agnostic_mode:
            ...
            display_class_name = display_str
        if not skip_scores:
          if not display_str:
        ...
        if agnostic_mode:
          ...
          if display_class_name in normal_classes:
            box_to_color_map[box] = STANDARD_COLORS[1]
          if display_class_name in abnormal_classes:
            box_to_color_map[box] = STANDARD_COLORS[2]
          

        curr_time = time.time()
        ticks = curr_time - start_time
        date_time = datetime.datetime.now()
        inst += 1
        print(inst,ticks,date_time,display_str)
